...
set f0 [open out0Reno_Reno_20_9BR.tr w]
set f1 [open out1Reno_Reno_20_9BR.tr w]
set f2 [open out2Reno_Reno_20_9BR.tr w]
...
set nf [open outReno_Reno_20_9BR.nam w]
set nf2 [open out_mainReno_Reno_20_9BR.tr w]
$ns namtrace-all $nf
$ns trace-all $nf2
